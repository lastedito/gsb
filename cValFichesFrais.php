 ...
 */
  ...
  $visiteur=lireDonneePost("lstVis","");
  ...
  if ($etape == "validerConsult") { // l'utilisateur valide ses nouvelles données
      ...
      $existeFicheFrais = existeFicheFrais($idConnexion, $moisSaisi, $visiteur);
      ...
      if ( !$existeFicheFrais ) {
          ...
          $tabFicheFrais = obtenirDetailFicheFrais($idConnexion, $moisSaisi, $visiteur);
      }
  }                                  
?>
  <!-- Division principale -->
       ...
       <p>
        ...
        <select id="lstVis" name="lstVis" title="Sélectionnez le visiteur souhaité pour la fiche de frais">
            <?php
                ...
                $req = "select * from visiteur where cat='visiteur'";
...
<?php          
            ...
            $req = obtenirReqEltsForfaitFicheFrais($moisSaisi, $visiteur);
...
<?php          
            ...
            $req = obtenirReqEltsHorsForfaitFicheFrais($moisSaisi, $visiteur);
